"""Stored-to-admin specialist — low-privileged stored input rendered to privileged users."""
...
class StoredToAdminSpecialist:
    NAME = "stored_to_admin"
    PROMPT = "specialists/stored_to_admin"
